...
{
    Dictionary<Vector3Int, HexOK> hexTileDict = new Dictionary<Vector3Int, HexOK>();
    Dictionary<Vector3Int,List<Vector3Int>> hexTileNeighboursDict = new Dictionary<Vector3Int, List<Vector3Int>>();

    private void Start()
    {
         foreach(HexOK hex in FindObjectsOfType<HexOK>())
        {
    ...
    public HexOK GetTileAt(Vector3Int hexCoordinates)
    {
        HexOK result = null;
